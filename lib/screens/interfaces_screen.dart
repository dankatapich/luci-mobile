...
class _InterfacesScreenState extends ConsumerState<InterfacesScreen> {
            ...
            LuciPullToRefresh(
              ...
              child: Builder(
                builder: (context) {
                  ...
                  final switchPortGroups =
                      _switchPortGroupsFromDashboard(dashboardData);
                  ...
                  return CustomScrollView(
                    ...
                    slivers: [
                      ...
                      if (switchPortGroups.isNotEmpty) ...[
                        SliverToBoxAdapter(child: LuciSectionHeader('Ports')),
                        _buildSwitchPortsList(switchPortGroups),
                      ],
  ...
  List<SwitchPortGroup> _switchPortGroupsFromDashboard(
    Map<String, dynamic>? dashboardData,
  ) {
    final rawGroups = dashboardData?['switchPorts'];
  ...
  Widget _buildSwitchPortsList(List<SwitchPortGroup> groups) {
    return SliverList(
      delegate: SliverChildBuilderDelegate((context, index) {
        final group = groups[index];
        return Padding(
          padding: const EdgeInsets.symmetric(horizontal: 16.0, vertical: 8.0),
          child: _SwitchPortsCard(group: group),
        );
...
class _SwitchPortsCard extends StatelessWidget {
  final SwitchPortGroup group;

  const _SwitchPortsCard({required this.group});
